...
func (e Endpoint) String() string {
	...
	case GetAppServeAppLog:
		return "GetAppServeAppLog"
	...
	case GetPolicyViolationLogDashboard:
		return "GetPolicyViolationLogDashboard"
	case GetPolicyStatisticsDashboard:
