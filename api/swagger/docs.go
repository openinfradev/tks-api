...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/1.0/admin/policytemplates/kind/{policyTemplateKind}/existence": {
            "get": {
                "security": [
                    {
                        "JWT": []
        ...
        "/api/1.0/admin/policytemplates/name/{policyTemplateName}/existence": {
            "get": {
                "security": [
                    {
                        "JWT": []
        ...
        "/api/1.0/admin/policytemplates/{policyTemplateId}": {
            "get": {
                "security": [
                    {
                        "JWT": []
        ...
        "/api/1.0/admin/policytemplates/{policyTemplateId}/deploy": {
            "get": {
                "security": [
                    {
                        "JWT": []
        ...
        "/api/1.0/admin/policytemplates/{policyTemplateId}/statistics": {
            "get": {
                "security": [
                    {
                        "JWT": []
        ...
        "/api/1.0/admin/policytemplates/{policyTemplateId}/versions": {
            "get": {
                "security": [
                    {
                        "JWT": []
        ...
        "/api/1.0/admin/policytemplates/{policyTemplateId}/versions/{version}": {
            "get": {
                "security": [
                    {
                        "JWT": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_openinfradev_tks-api_pkg_domain.ListOrganizationBody"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "github_com_openinfradev_tks-api_pkg_domain.ListOrganizationBody": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_openinfradev_tks-api_pkg_domain.Organization": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/github_com_openinfradev_tks-api_pkg_domain.OrganizationStatus"
                },
                "statusDesc": {
                    "type": "string"
                },
        ...
        "github_com_openinfradev_tks-api_pkg_domain.OrganizationStatus": {
            "type": "integer",
            "enum": [
                0,
                1,
