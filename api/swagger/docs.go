...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_openinfradev_tks-api_pkg_domain_admin.GetAlertTemplatesResponse"
                        }
                    }
                }
            },
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_openinfradev_tks-api_pkg_domain_admin.CreateAlertTemplateResponse"
                        }
                    }
                }
            }
        },
        "/admin/alert-templates/{alertTemplateId}": {
            "get": {
                "security": [
                    {
                        "JWT": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_openinfradev_tks-api_pkg_domain_admin.GetAlertTemplateResponse"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_openinfradev_tks-api_pkg_domain_admin.UpdateAlertTemplateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_openinfradev_tks-api_pkg_domain_admin.AlertTemplateResponse": {
            "type": "object",
            "required": [
                "metricQuery"
            ],
        ...
        "github_com_openinfradev_tks-api_pkg_domain_admin.CreateAlertTemplateResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "github_com_openinfradev_tks-api_pkg_domain_admin.GetAlertTemplateResponse": {
            "type": "object",
            "properties": {
                "alertTemplate": {
                    "$ref": "#/definitions/github_com_openinfradev_tks-api_pkg_domain_admin.AlertTemplateResponse"
                }
            }
        },
        "github_com_openinfradev_tks-api_pkg_domain_admin.GetAlertTemplatesResponse": {
            "type": "object",
            "properties": {
                "alertTemplates": {
                    "type": "array",
        ...
        "github_com_openinfradev_tks-api_pkg_domain_admin.UpdateAlertTemplateRequest": {
            "type": "object",
            "required": [
                "metricQuery",
                "name",
